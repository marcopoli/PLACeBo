...
public class Twokenize {
    ...
    public Twokenize(String a){
    	testo = a;
    	tokens = simpleTokenize ();
    }
    // The main work of tokenizing a tweet.
    private static List<String> simpleTokenize () {

        // Do the no-brainers first
        String splitPunctText = splitEdgePunct(testo);
    ...
    public static List<String> tokenize(String text){
    	Twokenize tw = new Twokenize(squeezeWhitespace(text));
        return simpleTokenize();
    }
